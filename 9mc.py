...
class State:
    ...
    def __eq__(self, other):
        return (self.left_missionaries, self.left_cannibals, self.boat, self.right_missionaries,
                self.right_cannibals) == \
               (other.left_missionaries, other.left_cannibals, other.boat, other.right_missionaries,
                other.right_cannibals)

    def __hash__(self):
        return hash((self.left_missionaries, self.left_cannibals, self.boat, self.right_missionaries,
                     self.right_cannibals))
